...
public class CalculatorTest {
    ...
    /* Домашнее задание к семинару №1 */
        ...
        assertThatThrownBy(() -> Calculator.calculatingDiscount(120, 101)).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() -> Calculator.calculatingDiscount(-1, 20)).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() -> Calculator.calculatingDiscount(120, -1)).isInstanceOf(ArithmeticException.class);
